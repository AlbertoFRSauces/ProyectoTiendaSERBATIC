...
function confirmarEliminacionProveedor(){
    var respuesta = confirm("¿Estas seguro que quieres eliminar el proveedor?");
    if(respuesta == true){
        return true;
    }else{
        return false;
...
function confirmarEliminacionDescuento(){
    var respuesta = confirm("¿Estas seguro que quieres eliminar el descuento?");
    if(respuesta == true){
        return true;
    }else{
        return false;
